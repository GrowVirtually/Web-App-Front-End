...
const ViewTable = () => {
  ...
  let columns = [
    { title: 'ID', field: 'id' },
    { title: 'Seller', field: 'user.fname' },
    { title: 'Gig Category', field: 'gigCategory' },
    { title: 'Gig Item', field: 'gigTitle' },
    { title: 'Description', field: 'gigDescription' },
    { title: 'Expire Date', field: 'expireDate' },
    { title: 'Avl Stock', field: 'stock' },
